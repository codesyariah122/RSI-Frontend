      ...
      methods: {
        SetCoordinates() {
          ...
          setTimeout(() => {
            ...
            {
              id: 1,
              category_name: this.city.city,
              maps: [
              {
                id: 1,
                title: this.city.city,
                lat: this.center_coord.lat,
                lng: this.center_coord.lng,
                region: `${this.city.city} City`,
                external_link:
                `https://www.google.com/maps/place/PPKC+CAROLUS/@${this.center_coord.lat},${this.center_coord.lng},15z/data=!4m5!3m4!1s0x0:0x3517379d92f3f299!8m2!3d${this.center_coord.lat}!4d${this.center_coord.lng}`,
              },
              ],
            },
            ];
